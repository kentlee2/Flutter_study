class MovieEntity {
	...
	MovieEntity.fromJson(Map<String, dynamic> json) {
		...
		if (json['subjects'] != null) {
			subjects = new List<MovieSubject>();(json['subjects'] as List).forEach((v) { subjects.add(new MovieSubject.fromJson(v)); });
		}
		count = json['count'];
		start = json['start'];
		title = json['title'];
...
class MovieSubject {
	...
	MovieSubject.fromJson(Map<String, dynamic> json) {
		images = json['images'] != null ? new MovieSubjectsImages.fromJson(json['images']) : null;
		originalTitle = json['original_title'];
		year = json['year'];
		if (json['directors'] != null) {
			directors = new List<MovieSubjectsDirector>();(json['directors'] as List).forEach((v) { directors.add(new MovieSubjectsDirector.fromJson(v)); });
		}
		rating = json['rating'] != null ? new MovieSubjectsRating.fromJson(json['rating']) : null;
		alt = json['alt'];
		title = json['title'];
		...
		if (json['casts'] != null) {
			casts = new List<MovieSubjectsCast>();(json['casts'] as List).forEach((v) { casts.add(new MovieSubjectsCast.fromJson(v)); });
		}
...
class MovieSubjectsDirector {
	...
	MovieSubjectsDirector({this.name, this.alt, this.id, this.avatars, this.nameEn});

	MovieSubjectsDirector.fromJson(Map<String, dynamic> json) {
		name = json['name'];
		alt = json['alt'];
		id = json['id'];
		avatars = json['avatars'] != null ? new MovieSubjectsDirectorsAvatars.fromJson(json['avatars']) : null;
		nameEn = json['name_en'];
	}
...
class MovieSubjectsRatingDetails {
	int a1;
	int a2;
	int a3;
	int a4;
	...
	MovieSubjectsRatingDetails({this.a1, this.a2, this.a3, this.a4, this.a5});

	MovieSubjectsRatingDetails.fromJson(Map<String, dynamic> json) {
		a1 = json['1'].toInt();
		a2 = json['2'].toInt();
		a3 = json['3'].toInt();
		a4 = json['4'].toInt();
...
class MovieSubjectsCast {
	...
	MovieSubjectsCast.fromJson(Map<String, dynamic> json) {
		...
		alt = json['alt'];
		id = json['id'];
		avatars = json['avatars'] != null ? new MovieSubjectsCastsAvatars.fromJson(json['avatars']) : null;
		nameEn = json['name_en'];
	}
